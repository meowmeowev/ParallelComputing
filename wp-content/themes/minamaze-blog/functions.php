...
function minamaze_thinkup_child_frontscripts() {
	...
	wp_enqueue_style( 'minamaze-thinkup-style-blog', get_stylesheet_directory_uri() . '/style.css', array( 'thinkup-style' ), wp_get_theme()->get('Version') );
}
...
function minamaze_thinkup_removeoption_child_settings() {
...
add_action( 'switch_theme', 'minamaze_thinkup_removeoption_child_settings' );

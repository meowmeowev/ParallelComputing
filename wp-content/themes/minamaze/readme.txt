...
The following opensource projects, graphics, fonts, API's or other files as listed have been used in developing this theme. Thanks to the author for the creative work they made. All creative works are licensed as being GPL or GPL compatible.
    ...
    [1.06] Item:        Custom made by Think Up Themes: transparent.png, featured1.png, featured2.png, featured3.png, slide_demo2.png, slide_demo3.png
           Item URL:    /images/slideshow
           Licence:     CC0
           Licence URL: https://creativecommons.org/publicdomain/zero/1.0/

    [1.07] Item:        Image shown in slider on screenshot.png and slide_demo1.png.
           Item URL:   https://pxhere.com/en/photo/971390
           Licence:     CC0
           Licence URL: https://creativecommons.org/publicdomain/zero/1.0/
...
= 1.8.3
- Updated: Improved accessibility by underlining links in content.
...
= 1.8.0
- New:     Blog layout customization code added.
...
- Fixed:   z-index for elements with value greater than #wpadminbar have been reduced to avoid conflict.
...
- Updated: Outline with hex #9fc1f7 displayed on focus to all relevant elements.
...
- Fixed:   All textdomains for translations correctly use "minamaze".
- Fixed:   All variables set to null in migration script before executing.
- Fixed:   Migration check improved to ensure only runs if slides pre v1.7.0 are present.
